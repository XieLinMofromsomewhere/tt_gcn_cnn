...
class Processor():
    ...
    def load_model(self):
        output_device = self.arg.device if type(self.arg.device) is list else self.arg.device
        self.output_device = output_device
        #self.output_device = 1
        Model = import_class(self.arg.model)    #加载agcn
        ...
        for ln in loader_name:
            ...
            if save_score:
                with open('{}/epoch{}_{}_score.pkl'.format(
                    ...
                    pickle.dump(score_dict, f,protocol=4)
